...
<Section pictogram={Websites} layout="left">
	...
	<p>
		...
		need to build from scratch. As an experienced web developer, I can build you a fully customized,
...
<Section pictogram={ArtTools_01} layout="right">
	...
	<p>
		...
		without an underlying brand identity - designed to fit <i>your</i> business and <i>your</i> market,
		you will be shooting in the dark. Whether you have an existing brand that needs a face-lift, or you
		are launching a shiny new brand, I can set you up with everything you need.
	</p>
</Section>
<Section pictogram={TextData} layout="left">
	...
	<p>
		...
		marketing copy for your website, technical documentation for your customers or team, or writing
		grant applications: I got you covered. Distilling an overwhelming wealth of information into a
		delightful, relevant bite-sized essence is not easy. I'll help you find select the content,
		structure the message and refine the tone so your message will be heard.
	</p>
</Section>
<Section pictogram={ChartMultiType} layout="right">
	...
	<p>
		...
		growth hacking on social media. I'll help you with finding the right mix of approaches for your
		situation. After helping you set up the tools, I'll teach you how to use them to do your own
		marketing.
	</p>
</Section>
<Section pictogram={AppDeveloper} layout="left">
	...
	<p>
		Are there some internal processes you are struggling with? Ever wonder if the right kind of app
		could save you a lot of time, money and headaches? I've helped with selection and management of
		tools in startups, and I keep up with the latest and greatest in business productivity apps. I
		can help you find and setup the right solution for your situation and budget.
	</p>
</Section>
